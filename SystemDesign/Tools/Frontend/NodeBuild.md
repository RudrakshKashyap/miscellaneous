...
export default defineConfig({
  plugins: [
    svgr(), // import SVG files directly as React components, allowing for easier manipulation, styling
    /*
    uncommet if needed
    This plugin is used to treat JS files as JSX files, allowing for easier manipulation, styling
    will affect /src folder
    */
    // {
    ...
    tailwindcss(), // This plugin is used to treat CSS files as Tailwind CSS files, allowing for easier manipulation, styling
  ],
  server: {
    port: 3001,
    open: true,
